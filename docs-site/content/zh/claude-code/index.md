...
## 快速开始
  ...
  - [1. 安装 Claude Code](/zh/claude-code/installation/)
  - [2. 配置模型供应商](/zh/claude-code/model-provider/)
  - [3. CCometixLine 状态栏](/zh/claude-code/contextline/)
  - [4. 配置 Skills](/zh/claude-code/skills/)
