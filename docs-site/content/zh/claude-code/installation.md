...
-   [Look2Eye API Key](https://api.look2eye.com/keys) （注册即可获取，无需 Claude 订阅）
...
安装完成后，请先完成 [配置模型供应商](/zh/claude-code/model-provider/) 再启动使用。
...
-   [配置模型供应商](/zh/claude-code/model-provider/) — 使用 Look2Eye 作为 API 提供商
-   [CCometixLine 状态栏](/zh/claude-code/contextline/) — 实时显示 Git 状态、模型、上下文用量
-   [配置 Skills](/zh/claude-code/skills/) — 扩展 Claude Code 能力
