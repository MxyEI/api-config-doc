...
推荐先用 CC Switch 配好 Look2Eye 供应商和 API Key。完成后再开启 WebSocket，让 Codex 长时间编码会话更流畅。
...
-   [开启 WebSocket（推荐）](websocket.md) — 补齐 Responses 协议格式和 WebSocket 长连接配置，让长时间编码会话更流畅
