...
> ⚠️ This extension requires a **GitHub Copilot Individual subscription** and does not support Copilot Business or Enterprise users. If you don’t have a Copilot subscription, consider using [Cursor](cursor.md) or [Cherry Studio](cherry-studio.md) instead.
