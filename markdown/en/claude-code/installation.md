...
After installation, complete the [Model Provider Configuration](model-provider.md) before starting.
...
- [Configure Model Provider](model-provider.md) — Use Look2Eye as the API provider
- [CCometixLine Status Bar](contextline.md) — Real-time display of Git status, model, and context usage
- [Configure Skills](skills.md) — Extend Claude Code capabilities
